...
from cli.commands import test, clean, config, docs, quality, health, deploy, wan, models
...
app.add_typer(models.app, name="models", help="Model Orchestrator - Unified model management for WAN2.2")
